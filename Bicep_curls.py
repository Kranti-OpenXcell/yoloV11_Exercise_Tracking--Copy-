...
class ExerciseTracker:
    def __init__(self, model_path='/home/kranti/Documents/yolov7-object-tracking-main/yolo11n-pose.pt'):  
        ...
        try:
            for keypoints in people:
                ...
                if right_elbow_angle and left_elbow_angle:
                    ...
                    # Going up condition
                    elif (right_elbow_angle > 150 or left_elbow_angle > 150):
                ...
                cv2.putText(frame, f'ID: {person_id}', (right_shoulder[0] - 50 , right_shoulder[1] - 40),
                           cv2.FONT_HERSHEY_SIMPLEX,2.5, (0, 0, 0), 3)
                
                # Display rep count
                cv2.putText(frame, f'Reps: {self.people_data[person_id]["reps"]}',
                           (right_shoulder[0] - 150, right_shoulder[1] + 40),
                           cv2.FONT_HERSHEY_SIMPLEX, 2.5, (0, 0, 0), 3)
...
def main(video_path):
    ...
    output_path = os.path.join(os.getcwd(), "BicepCurl_output_video1.mp4")
    ...
    while cap.isOpened():
        ...
        # 500,750 for pexxels video
        # frame = cv2.resize(frame, (450, 850))
...
if __name__ == "__main__":
    ...
    # parser.add_argument(
    #     '--video_path',  # Argument name in the command line (you can use --video_path)
    #     type=str, 
    #     required=True,  # Make sure this argument is required
    ...
    main('/home/kranti/Documents/yoloV11_Exercise_Tracking/Input_Video/Biceps_curls/bicep_curl1.mp4')