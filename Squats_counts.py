        ...
        try:
            for keypoints in people:
                ...
                if right_elbow_angle and left_elbow_angle:
                    ...
                    if (right_knee_angle < 60 or right_knee_angle < 60):
                    ...
                    # Going up condition
                    elif (right_knee_angle > 150 or left_knee_angle > 150):
                ...
                if left_knee_angle is not None:
                    cv2.putText(frame, f'{int(left_knee_angle)}', left_hip, 
                              cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
                if right_knee_angle is not None:
                    cv2.putText(frame, f'{int(right_knee_angle)}', left_hip, 
                              cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
                ...
                cv2.line(frame, right_hip, left_ankle, (0, 255, 0), 2)
                cv2.line(frame, left_hip, right_ankle, (0, 255, 0), 2)
...
def main(video_path):
    ...
    while cap.isOpened():
        ...
        # frame = cv2.resize(frame, (590, 950))
...
if __name__ == "__main__":
    ...
    # parser.add_argument(
    #     '/home/kranti/Documents/yolov7-object-tracking-main/Video/Biceps_curls/bicep_curls7.mp4', 
    #     type=str, 
    ...
    main('/home/kranti/Downloads/Exercise-Counter-with-YOLOv8-on-NVIDIA-Jetson-main/video/squats2.mp4')